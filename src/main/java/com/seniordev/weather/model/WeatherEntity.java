package com.seniordev.weather.model;
...
public class WeatherEntity {
    ...
    public WeatherEntity(String city, String name, String country, String temperature, LocalDateTime now, LocalDateTime parse) {
    }
